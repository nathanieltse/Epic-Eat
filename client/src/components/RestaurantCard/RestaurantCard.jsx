    ...
    return (
        <article className="RestaurantCard">
            <div className="RestaurantCard__image-container">
                <img className="RestaurantCard__image" src="https://media.cntraveler.com/photos/5b22bfdff04a775484b99dfc/1:1/w_800%2Cc_limit/Alo-Restaurant__2018_Raffi-Photo-2.jpg" alt="restaurant photo"/>
            </div>
